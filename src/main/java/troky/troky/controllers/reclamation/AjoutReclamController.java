package troky.troky.controllers.reclamation;
...
import troky.troky.services.ReclamationService;
...
public class AjoutReclamController implements Initializable {
        ...
        @FXML
        private Label lblImagePath; // un Label pour afficher le chemin de l'image
